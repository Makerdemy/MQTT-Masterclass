...
#define ORG "j5sxd2"
#define DEVICE_TYPE "esp32room2"
#define DEVICE_ID "esp32r2"
#define TOKEN ""

char server[] = ORG ".messaging.internetofthings.ibmcloud.com";
char pubTopic1[] = "iot-2/evt/status4/fmt/json";
char pubTopic2[] = "iot-2/evt/status5/fmt/json";
char authMethod[] = "use-token-auth";
char token[] = TOKEN;
char clientId[] = "d:" ORG ":" DEVICE_TYPE ":" DEVICE_ID;

char willTopic[]="iot-2/evt/status6/fmt/json";
int willQos=0;
boolean willRetain=false;   
char willMessage[]= "{\"sensor\":\"dht11\",\"disabledsensorid\":2,\"status\":0}";
